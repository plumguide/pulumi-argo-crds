...
export class WorkflowTemplate extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.argoproj.v1alpha1.WorkflowTemplateSpec>;
...
export interface WorkflowTemplateArgs {
    ...
    readonly kind?: pulumi.Input<"WorkflowTemplate">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    readonly spec?: pulumi.Input<inputs.argoproj.v1alpha1.WorkflowTemplateSpec>;
}
